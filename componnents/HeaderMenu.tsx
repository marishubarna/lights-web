    ...
    <div className="flex flex-col w-full">
      ...
      <div className="navbar bg-white max-w-7xl mx-auto px-4 py-3 relative z-[1010] border-b border-gray-200">
        ...
        <div className="lg:hidden flex items-center gap-3">
          ...
          <a
            href="tel:+14168416302"
            className="flex items-center gap-1 px-3 py-2 bg-white text-[#324ef1] border border-[#324ef1] rounded-4xl font-semibold hover:bg-[#324ef1] hover:text-white transition-all text-sm"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="w-4 h-4 text-[#324ef1] hover:text-white transition-colors"
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
